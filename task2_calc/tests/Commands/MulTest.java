...
class MulTest {
    ...
    @Test
    @DisplayName("Testing MUL with more arguments than expected")
    ...
    @Test
    @DisplayName("Testing MUL with not enough data in stack (0 arguments in stack)")
    ...
    @Test
    @DisplayName("Testing MUL with not enough data in stack (1 arguments in stack)")
    ...
    @Test
    @DisplayName("Testing MUL with correct data")
