...
class SumTest {
    ...
    @Test
    @DisplayName("Testing SUM with more arguments than expected")
    ...
    @Test
    @DisplayName("Testing SUM with not enough data in stack (0 arguments in stack)")
    ...
    @Test
    @DisplayName("Testing SUM with not enough data in stack (1 arguments in stack)")
    ...
    @Test
    @DisplayName("Testing SUM with correct data")
